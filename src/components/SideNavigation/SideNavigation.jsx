      ...
      {open ? (
        <>
          ...
          <List>
            ...
            <Link to="viewallusers" onClick={toggleDrawer} style={{ textDecoration: 'none' }}>
              <ListItem button sx={{ '&:hover': { backgroundColor: theme.palette.action.hover } }}>
                <ListItemIcon>
                  <AccountCircleIcon sx={{ color: '#757AEF' }} />
                </ListItemIcon>
                <ListItemText primary="All Users" sx={{ color: '#757AEF' }} />
              </ListItem>
            </Link>
            <Link to="viewalllabs" onClick={toggleDrawer} style={{ textDecoration: 'none' }}>
              <ListItem button sx={{ '&:hover': { backgroundColor: theme.palette.action.hover } }}>
                <ListItemIcon>
                  <SettingsIcon sx={{ color: '#757AEF' }} />
                </ListItemIcon>
                <ListItemText primary="All Labs" sx={{ color: '#757AEF' }} />
              </ListItem>
            </Link>
          </List>
        </>
